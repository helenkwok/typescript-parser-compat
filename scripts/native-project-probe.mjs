    ...
    return {
      ...
      apiSurface: {
        ...
        node: {
          ...
          getWidth: isFunction(firstStatement?.getWidth),
          getFullWidth: isFunction(firstStatement?.getFullWidth),
          getLeadingTriviaWidth: isFunction(
            firstStatement?.getLeadingTriviaWidth,
          ),
          getChildren: isFunction(firstStatement?.getChildren),
          getChildCount: isFunction(firstStatement?.getChildCount),
          getChildAt: isFunction(firstStatement?.getChildAt),
